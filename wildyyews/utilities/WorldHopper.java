...
public class WorldHopper {
	...
	private static final int[] WORLDS = {1,2,3,4,5,6,8,9,10,11,12,13,14,16,17,18,19,20,21,
		22,25,26,27,28,29,30,33,34,35,36,37,38,41,42,43,44,45,46,49,50,51,52,53,54,57,58,
		59,60,61,62,65,66,67,68,69,70,73,74,75,76,77,78};
	...
	private static boolean selectWorld(int world){
		...
		while(isOnWorldSelect()){
			Mouse.clickBox((int)r.getX(),(int)r.getY(),(int)(r.getX()+r.getWidth()),(int)(r.getY()+r.getHeight()), 1);
